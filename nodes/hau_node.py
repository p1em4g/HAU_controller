...
class HAUNode(BaseNode):
    def __init__(self, endpoint: str, list_of_nodes: list, is_daemon: bool = True):
        ...
        self.exp_note = "21.10.22 Первая планка посажена в 15 00. " \
                        "25.10.22 Перезапуск программы. Посажена планка в КМ2. Закомментированных методов нет."
        ...
        self.min_critical_pressure_in_root_module_1 = 3.68  # 3,68 В соответсвует -1,5 кПа в КМ1
        self.min_critical_pressure_in_root_module_2 = 3.42  # 3,42 В соответсвует -1,5 кПа в КМ2
        ...
        self.humidify_active_time = timedelta(seconds=297)  # 297 c - 80 ml показывает, сколько времени в сумме должен проработать насос
